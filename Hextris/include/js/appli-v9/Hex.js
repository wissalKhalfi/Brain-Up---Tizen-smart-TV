...
function Hex(sideLength) 
{
	...
	/**
	 * Collision d'un bloc avec un autre
	 * 
	 * @param  {[type]} block    [description]
	 * @param  {[type]} position [description]
	 * @param  {[type]} tArr     [description]
	 * @return {[type]}          [description]
	 */
	...
	{
        if(Date.now()-this.lastRotate<75 && !(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) ) 
        	return;
...
/**
 * Convertit un tableau en couleur RGB
 * 
