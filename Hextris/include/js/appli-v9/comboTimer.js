 ...
 * Calcul les côtés
 * 
 * @param  {[type]} startVertex [description]
 * @param  {[type]} endVertex   [description]
...
/**
 * Dessine les côtés de la forme
 * 
 * @param  {[type]} vertexes [description]
 * @return {[type]}          [description]
 */
