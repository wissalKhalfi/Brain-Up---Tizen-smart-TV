...
function checkGameOver() 
{
    for (var i = 0; i < MainHex.sides; i++) 
    {
        ...
        {
            $.get('http://programmation-facile.com/' + String(score))
...
function showHelp() 
{
    $("#inst_main_body").html("Le but de Hextris est d'empêcher les blocs de sortir de la zone limite de l'hexagone central<br><br>" + (settings.platform != 'mobile' ? 'Utilisez les flèches directionnelles gauche et droite' : 'appuyez sur les côtés gauche et droite de l\'écran') + " pour tourner l'Hexagone central<br><br>Effacez les blocs et gagnez des points avec 3 blocs adjacents<br><br>Durée restante pour effectuer un combo, indiquée par  <span style='color:#f1c40f;'>la</span> <span style='color:#e74c3c'>ligne</span> <span style='color:#3498db'>de couleur</span> <span style='color:#2ecc71'>autour</span> de l'hexagone<br><br> " + (settings.platform == 'mobile' ? 'Accélérez la vitesse du jeu en appuyant sur l\'hexagone central' : "Multipliez la vitesse du jeu x2 en maintenant la flèche directionnelle du bas"));
